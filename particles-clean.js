// particles-clean.js — Molecule-like decorative shapes with nodes that avoid the mouse
(function () {
  ...
  // node glow gradient (increased to make glow more visible)
  const nodeGlowRadius = r * (4 + 16 * localStrength);
